...
public class VendorPortal {
    ...
    public static void main(String[] args) {
        ...
        while (!exit) {
            ...
            switch (choice) {
                case 0:
                    facade.showCatalog(); // Call to the facade
                    break;
                case 1:
                    ...
                    facade.addCatalog(id, name, price); // Call to the facade
                ...
                case 2:
                    ...
                    facade.updateInventory(productId, quantity); // Call to the facade
                    System.out.println("Product inventory updated.");
                    break;
                case 3:
                    facade.saveFile(); // Call to the facade
                    System.out.println("Catalog and inventory data saved to file.");
                    break;
                case 4:
                    facade.undoLastAction(); // Call to the facade
                    break;
                case 5:
                    exit = true;
                    break;
